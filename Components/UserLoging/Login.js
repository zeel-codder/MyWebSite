...
const Login = (props) => {
  ...
  return (
    <div className="Log">
      ...
      <form
        className={`form ${
          state.isLoginOpen ? "form-login" : "form-singin"
        } open`}
        onSubmit={(e) => {
      ...
      >
        {!state.isLoginOpen && (
          <div>
            <input
              ...
              onChange={(e) =>
                Reducer({ type: "setname", data: e.target.value })
              }
              value={state.name}
              type="name"
              name="name"
        ...
        <div>
          <input
            className="form-input"
            onChange={(e) =>
              Reducer({ type: "setEmail", data: e.target.value })
            }
            value={state.email}
            type="email"
            name="email"
        ...
        <button className="btn" type="submit">
          {state.isLoginOpen ? LoginKey : SingUpKey}
        </button>

        <span className="alert" style={{ color: "green", fontWeight: "bold" }}>
          OR
        </span>
