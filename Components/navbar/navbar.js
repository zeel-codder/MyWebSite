    ...
    <>
      ...
      <div className={`icon nav-icon`}>
        <span onClick={NavbarDisplay}>
          {showLinks ? <CancelIcon /> : <ViewWeekIcon></ViewWeekIcon>}
        </span>
      </div>
      <div className="navbar">
        <div className="navbar-item" ref={linksContainerRef}>
          <ul className="navabar-ul" ref={linksRef}>
            ...
            <div>
              <li className="a">
                <Link href="/">Zeel Blogs</Link>
              </li>
              <li>
                <Link href="/me/zeel">About Me</Link>
              </li>
              <li>
                <Link href="/me/tools">Projects</Link>
              </li>
            </div>
            {/* 
            <li className="Login-Page" ref={linksRefs}>
              {User == null ? (
                <>
                  <div className="login">
                    <Link href="/auth/singup" title="Sing Up">
                      Sing Up
                    </Link>
                  </div>
                  <div className="login">
                    <a href="/auth/login" title="Log In">
                      Log In
                    </a>
                  </div>
                </>
